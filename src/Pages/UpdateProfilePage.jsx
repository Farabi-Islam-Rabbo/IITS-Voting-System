...
import { UpdateProfile, GetProfileById } from "../Services/allService";
...
function CreateProfilePage({ user }) {
  ...
  const setData = async (response) => {
    ...
    setAnnualCharge(response.data?.annualCharge);
  };
  ...
  return (
    <MainWrapper>
      <Sidebar title="Update Profile" breadcrumb={breadcrumbs}>
