...
function AllWing({ user, na }) {
  ...
  const getWing = async () => {
    setPageLoading(true);
    const response = await GetAllWing();
    setWing(response)
    console.log(response);
  ...
  return (
    <MainWrapper>
      <AdminSideBar
        ...
        buttonHref={"/create-Wing"}
        buttonTitle="Create Wing"
      >
...
export default connect(mapStateToProps)(AllWing);
