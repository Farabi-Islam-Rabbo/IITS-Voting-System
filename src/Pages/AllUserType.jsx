  ...
  return (
    <MainWrapper>
      <AdminSideBar
        ...
        buttonHref={"/create-usertype"}
        buttonTitle="Create User Type"
      >
...
export default connect(mapStateToProps)(AllUserType);
