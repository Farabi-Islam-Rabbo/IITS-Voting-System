...
function UpdateCustoms({ user }) {
  ...
  const getPermissions = async () => {
    const response = await GetPermissionListByType("custom");
  ...
  return (
    <MainWrapper>
      <Sidebar title="Update Customs" breadcrumb={breadcrumbs}>
        <div className="flex flex-col px-4 py-6 pt-3 mt-4 bg-white rounded md:pt-3 mx-auto">
          <>
            <div className="flex items-center justify-between py-2 border-b-2">
              <span className="font-bold capitalize">Customs</span>
            </div>
...
export default connect(mapStateToProps)(UpdateCustoms);
