...
// export default function UpdateSubAdmins() {
//   return <div>UpdateSubAdmins</div>;
// }
...
function UpdateSubAdmins({ user }) {
  ...
  return (
    <MainWrapper>
      <Sidebar title="Update Sub-Admin" breadcrumb={breadcrumbs}>
...
export default connect(mapStateToProps)(UpdateSubAdmins);
